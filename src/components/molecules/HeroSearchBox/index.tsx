...
export default function HeroSearchBox({
  ...
  return (
    <div className={`${styles.heroSearchBox} ${className}`} ref={searchBoxRef}>
      <div className={styles.heroSearchBoxInput}>
        <Input
          type="search"
            ...
            {suggestions.map((suggestion, index) => (
              <button
                ...
                className={`${styles.heroSuggestionItem} ${
                  index === selectedIndex ? styles.heroSuggestionItemActive : ''
                }`}
        ...
        {showSuggestions && isLoading && (
          <div className={styles.heroSuggestionsList}>
            <div className={styles.heroSuggestionItem}>
              <span>검색 중...</span>
            </div>
          </div>
        )}
